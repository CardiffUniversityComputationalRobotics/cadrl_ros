...
class Agent:
    ...
    def update_state(self, action, dt):
        ...
        selected_heading = util.wrap(
            action_to_execute[1] + self.heading_global_frame
        )  # in global frame
        ...
        self.heading_ego_frame = util.wrap(
            self.heading_global_frame - ref_prll_angle_global_frame
        )
    ...
    def observe(self, agents):
        ...
        obs[
            Config.AGENT_ID_LENGTH
            + Config.FIRST_STATE_INDEX : Config.AGENT_ID_LENGTH
        ...
        for i, other_agent in enumerate(agents):
            ...
            rel_pos_to_other_global_frame = (
                other_agent.pos_global_frame - self.pos_global_frame
            )
        ...
        for other_agent in clipped_sorted_agents:
            ...
            dist_2_other = (
                np.linalg.norm(rel_pos_to_other_global_frame)
                - self.radius
                - other_agent.radius
            )
